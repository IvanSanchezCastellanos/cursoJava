package ejercicio01ooLanzadorList;

import com.curso.java.ejercicio01oo.model.Alumno;
import com.curso.java.ejercicio01oo.model.Aula;
import com.curso.java.ejercicio01oodao.ejercicio01oodao.ListAulaDAO;

import ejercicio01oonegocio.AulasLN;

public class LanzadorAulaList {

	public static void main(String[] args) {

		AulasLN negocio = new AulasLN(new ListAulaDAO());
